...
import com.phegondev.Phegon_Ecommerce.exception.InvalidCredentialsException;
...
public class ProductController {
	...
	public ResponseEntity<Response> name(@PathVariable Long categoryId) {
		return ResponseEntity.ok(productService.getProductsByCategory(categoryId));
	}
	
	@GetMapping("/search")
	public ResponseEntity<Response> name(@RequestParam String searchValue) {
